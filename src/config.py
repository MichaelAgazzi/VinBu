...
PEDUNCLE_SEGMENTATION_MODEL = (
    MODELS_DIR / "grape_peduncle_roi_yolo26m_transfer_mask1_640_b3_best.pt"
)
DIRECT_PEDUNCLE_SEGMENTATION_MODEL = (
    MODELS_DIR / "grape_peduncle_yolo26m_multiscale_768_b4_best.pt"
)
DEFAULT_EPOCHS = 50
DEFAULT_IMGSZ = 640
DEFAULT_BATCH = -1
...
DEFAULT_PEDUNCLE_CONF_THRESHOLD = 0.36
DEFAULT_DIRECT_CLUSTER_CONF_THRESHOLD = 0.40
DEFAULT_DIRECT_PEDUNCLE_CONF_THRESHOLD = 0.20
DEFAULT_DIRECT_IMGSZ = 960
